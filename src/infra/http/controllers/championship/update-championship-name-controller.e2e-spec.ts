...
describe('Update Championship Name (E2E)', () => {
  ...
  test('[PATCH] /championship/update-name', async () => {
    ...
    const response = await request(app.getHttpServer())
      .patch('/championship/update-name')
      .set('Authorization', `Bearer ${accessToken}`)
      .send({
        championshipName: 'Test Championship',
        newChampionshipName: 'New Test Championship',
      })
